...
user = User.create!(name: 'Roberval', email: 'roberval@algumacoisa.com', registration_number: '70535074670', password: 'password')
admin = User.create!(name: 'Sílvia', email: 'silvia@leilaodogalpao.com.br', registration_number: '70535075642', password: 'password')
