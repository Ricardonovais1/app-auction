...
Timecop.travel(expired_lot_time)
  ...
  lot_expired_b = Lot.create!(code: 'YYY090909', start_date: 1.month.from_now, limit_date: 3.months.from_now, 
                              minimum_bid_value: 200, minimum_bid_difference: 20,
                              by: 'Déia', by_email: 'deia@leilaodogalpao.com.br') 
  lot_expired_c = Lot.create!(code: 'XXX090909', start_date: 1.month.from_now, limit_date: 3.months.from_now, 
