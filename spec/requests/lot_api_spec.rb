...
describe 'LOT api' do
  ...
  context 'GET /api/V1/lots' do
    it 'com sucesso e ordenado por código em ordem alfabética' do
      # Arrange
      Lot.create!(code: 'CHC131313', start_date: 2.day.from_now, limit_date: 5.day.from_now,
                  minimum_bid_value: 300, minimum_bid_difference: 30)
      Lot.create!(code: 'BHB131212', start_date: 2.day.from_now, limit_date: 1.month.from_now,
