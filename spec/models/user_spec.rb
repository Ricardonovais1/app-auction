...
RSpec.describe User, type: :model do
 describe '#valid?' do 
  ...
  it 'false quando CPF é inválido' do
    u = User.new(name: 'Ricardo', email: 'ricardo@amigoviolao.com', registration_number: '705350746', password: 'password')
  ...
  it 'falso quando CPF não inclui apenas números' do
    u = User.new(name: 'Ricardo', email: 'ricardo@amigoviolao.com', registration_number: '705.350.746-70', password: 'password')
