...
describe 'Usuário edita lote' do
  it 'com sucesso' do
    admin = User.create!(name: 'Rafael', email: 'rafael@leilaodogalpao.com.br', registration_number: '05182085087',
                         password: 'password')
    Lot.create!(code: 'LPF892645', start_date: 3.days.from_now, limit_date: 1.month.from_now,
  ...
  it 'só se for admin' do
    user = User.create!(name: 'Rafael', email: 'rafael@exemplo.com.br', registration_number: '05182085087',
                        password: 'password')
    lote = Lot.create!(code: 'LPF892645', start_date: 3.days.from_now, limit_date: 1.month.from_now,
                       minimum_bid_value: 1000, minimum_bid_difference: 50,
                       by: 'Rafael', by_email: 'rafael@leilaodogalpao.com.br')
  ...
  it 'somente se for quem criou o lote' do
    User.create!(name: 'Rafael', email: 'rafael@leilaodogalpao.com.br',
                 registration_number: '05182085087', password: 'password')
    admin_editor = User.create!(name: 'Sandra', email: 'sandra@leilaodogalpao.com.br',
                                registration_number: '47782844029', password: 'password')
    lote = Lot.create!(code: 'LPF892645', start_date: 3.days.from_now, limit_date: 1.month.from_now,
                       minimum_bid_value: 1000, minimum_bid_difference: 50,
                       by: 'Rafael', by_email: 'rafael@leilaodogalpao.com.br')
