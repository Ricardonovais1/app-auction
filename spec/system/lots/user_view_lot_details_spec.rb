...
describe 'Usuário vê a tela de detalhes do lote' do
  ...
  it 'e não vê informações sobre admin que criou o lote' do
    # Arrange
    user = User.create!(name: 'Ricardo', email: 'ricardo@email.com.br', registration_number: '70535073607',
                        password: 'password')
    Lot.create!(code: 'AAA000000', start_date: '2090-10-20', limit_date: '2090-10-30',
  ...
  it 'e vê itens do lote' do
    ...
    item_b = Item.create!(name: 'Teclado logitech', description: 'Teclado super mega plus', weight: 200, height: 3,
    ...
    LotItem.create!(item: item_a, lot:)
    LotItem.create!(item: item_b, lot:)
